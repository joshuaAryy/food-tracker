...
- Phase 17.5 is complete after completed Phase 17. Its source of truth is the
  ...
  Phase 18/19 — Food Data + Intelligent Retrieval — is complete and merged in
  main. The next work is the combined Phase 20–22 product-hardening and
  intelligence macro phase, which must be audited before implementation.
